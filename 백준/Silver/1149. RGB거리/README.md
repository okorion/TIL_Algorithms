...
### 문제풀이 실패 지점 (1시간 50분 소요)

=> 문제를 잘못 이해해서 순열로 풀었음. (permutations 이용하여 input의 각 행에서 인덱스들을 안겹치게, 그 값들을 뽑아낸 뒤에 값들의 합을 구함.)

=> 문제 이해하고 재귀함수, 백트래킹으로 풀다가 실패.

=> 구글링. 정답 코드 이해하는데 시간 약간 걸림.
